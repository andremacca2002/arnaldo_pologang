...
public class STR {
	public static final String MSG_BENVENUTO = "ciao sono la massaia";
	public static final String MSG_SALUTI = "arriverci!";
	public static final String SCELTA = "scegli una opzione: ";
	public static final String OPZIONE_5_MENU_PRINC = "trova menù";
	public static final String OPZIONE_4_MENU_PRINC = "visualizza elenco ricette";
	public static final String OPZIONE_3_MENU_PRINC = "aggiungi ricetta";
	public static final String OPZIONE_2_MENU_PRINC = "visualizza elenco ingradienti";
	public static final String OPZIONE_1_MENU_PRINC = "aggiungi ingrediente";
	
	//MENU
	public static final String MSG_SECONDOPIATTO = "\nsecondopiatto:\n ";
